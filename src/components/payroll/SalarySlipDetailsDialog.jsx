...
const SalarySlipDetailsDialog = ({ slip, open, onOpenChange }) => {
  ...
  const structureBreakdown = JSON.parse(slip.structure_breakdown || '{"breakdown":[]}');
  const attendanceBreakdown = JSON.parse(slip.attendance_breakdown || '{}');
                 ...
                 <Table>
                    <TableBody>
                        ...
                        <TableRow className="font-bold bg-slate-50 dark:bg-slate-800">
                         ...
                         <TableRow>
                            <TableCell className="text-muted-foreground">Unpaid Days</TableCell>
